...
// STEP 6: Capture each product name and price as variables 
	...
	let itemPrice = products[i][1].toFixed(2);
...
// STEP 7: Create a TR element for this product and price in the invoice table
	...
	// STEP 9: Set the above string as the innerHTML of the new TR element, and then append 
	// the new 	element to the table body (var productList)
