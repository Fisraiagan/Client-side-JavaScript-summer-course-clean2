...
thumbBar.addEventListener('click',function(event){
	...
	if(event.target && event.target.nodeName === 'IMG'){
		...
		console.log(imgSrc);
		displayImage(imgSrc);
		// Lab 6 STEP A: Inside the thumbBar.onclick event handler function, and 
		// also inside the if statement, change the event.target CSS outline property to "5px solid red"
