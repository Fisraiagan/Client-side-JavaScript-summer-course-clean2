...
this.description = function(){
    return `A ${this.size} ${this.type} coffee with ${this.qtyCream} cream(s) and ${this.qtySugar} sugar(s).`;
}

}
/* STEP 2: Instatiate a coffee based on the above constructor function */
    let cup = new Coffee("Large", true, 2, 2);
    output.textContent = cup.description();
...
let cup3 = new cup.constructor("Medium", false, 3, 2);
